...
func TestSigner(t *testing.T) {
	...
	fmt.Println(int(OverheatLockCounter), len(inputData))
	fmt.Println(int(OverheatUnlockCounter), len(inputData))
	fmt.Println(int(DataSignerMd5Counter), len(inputData))
	fmt.Println(int(DataSignerCrc32Counter), len(inputData)*8)
